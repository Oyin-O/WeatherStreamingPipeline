        ...
        <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
            <div>
                ...
                <div style="color:{MUTED}; font-size:.85rem; margin-top:6px;">
                    Kafka → Spark → Supabase (PostgreSQL)  · auto-refresh 10s
                </div>
            </div>
            <div style="text-align:right;">
                ...
                ">
                    ...
                    LIVE &nbsp;·&nbsp; {last_updated.strftime('%A, %d %B %Y·%H:%M:%S')}
                </div>
            </div>
        </div>
    </div>
...
def _card(row: dict) -> str:
    ...
    local_time = row.get("local_timestamp")
    ...
    ">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
            <div>
                ...
                <div style="font-size:.72rem;color:{MUTED};margin-top:8px;">🕐 {local_time}</div>
            </div>
